  ...
  return (
    <>
      ...
      <div className="relative overflow-hidden">
        <div className="container py-24 lg:py-32 text-center mx-auto">
          <div className="text-center">
            ...
            <div className="mt-7 sm:mt-12 mx-auto max-w-xl relative">
              {/* Form */}
              <form className="border bg-background rounded-lg shadow-lg px-2">
                <div className="relative z-10 flex space-x-3 p-3 ">
